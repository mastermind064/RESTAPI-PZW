...
/*tes unit untuk user controller
* success
* failed
* duplicate
* */
...
class UserControllerTest {
    ...
    /*bikin test untuk kirim data
    * 1. bikin request, convert request ke json menggunakan object mapper
    * 2. response yang diharapkan adalah OK
    * 3. cek isi response, convert response ke class web response menggunakan object mapper
    * 4. isi response harus OK
    * */
    @Test
    ...
    void updateUserSuccess() throws Exception{
        ...
        mockMvc.perform(
            ...
            assertNull(response.getErrors());
            assertEquals("ujicoba", response.getData().getName());
            assertEquals("test", response.getData().getUsername());
